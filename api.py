...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if username == ADMIN_USERNAME:
        msg += (
            ...
            "```\n"
            "🎭 **MASK MANAGEMENT**\n\n"
            "`/addmask <word>` - Mask Developer Name\n"
            "`/removemask <word>` - Unmask Word\n"
            "`/listmask` - View Masked Words\n\n"
            "```\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "```\n"
            "⚡ **CUSTOM COMMANDS**\n\n"
            "`/addcommand <name> <url>` - Add Feature\n"
            "`/removecommand <name>` - Remove Feature\n"
            "`/listcommands` - View Custom Features\n\n"
            "```\n"
            "╔═══════════════════════════════╗\n"
